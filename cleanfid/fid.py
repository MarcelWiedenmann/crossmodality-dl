...
def get_folder_features(fdir, model=None, num_workers=12, num=None,
    ...
    # NOTE: The following lines have been patched for the implementation of the thesis.
    ...
    if verbose:
        # NOTE: The following lines have been patched for the implementation of the thesis.
        folder_path = fdir if not isinstance(fdir, list) else fdir[0]
        print(f"Found {len(files)} images in the folder {folder_path}")
...
def compare_folders(fdir1, fdir2, feat_model, mode, num_workers=0,
    ...
    # NOTE: The following line has been patched for the implementation of the thesis.
    fbname1 = os.path.basename(fdir1) if not isinstance(fdir1, list) else fdir1[0].parent.name
    ...
    # NOTE: The following line has been patched for the implementation of the thesis.
    fbname2 = os.path.basename(fdir2) if not isinstance(fdir2, list) else fdir2[0].parent.name
